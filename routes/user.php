    ...
    Route::middleware(['check.status'])->group(function () {
        ...
        Route::middleware('registration.complete')->namespace('User')->group(function () {
            ...
            Route::controller('ProfileController')->group(function(){
                ...
                Route::get('transaction-password', 'transactionPassword')->name('transaction.password');
                Route::post('transaction-password', 'setTransactionPassword')->name('transaction.password.set');
            });

            // Lucky Wheel (Roue de la Chance)
            Route::controller('LuckyWheelController')->prefix('lucky-wheel')->name('lucky.wheel.')->group(function(){
                Route::get('/', 'index')->name('index');
                Route::post('/spin', 'spin')->name('spin');
            });

            // Comptes de retrait enregistrés
            Route::controller('WithdrawalAccountController')->prefix('withdrawal-accounts')->name('withdrawal.accounts.')->group(function(){
                Route::get('/', 'index')->name('index');
        ...
        Route::middleware('registration.complete')->prefix('deposit/westpay')->name('deposit.westpay.')->controller('WestPayController')->group(function () {
            Route::get('/', 'showForm')->name('form');
            Route::post('initiate', 'initiate')->name('initiate');
            Route::get('return', 'returnHandler')->name('return');
        });
    });
});
