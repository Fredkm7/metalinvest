            ...
            <div class="modal-content">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Image du plan <small class="text-muted">(PNG, JPG — 400x400px recommandé)</small></label>
                            <div class="d-flex align-items-center gap-3">
                                <div class="plan-img-preview" style="width:80px;height:80px;border-radius:8px;background:#f0f4ff;display:flex;align-items:center;justify-content:center;overflow:hidden;border:1px solid #dde5ff;">
                                    <img class="plan-current-img" src="" alt="" style="width:100%;height:100%;object-fit:cover;display:none;">
                                    <span class="plan-img-placeholder" style="font-size:24px;color:#94a3b8;">★</span>
                                </div>
                                <input type="file" class="form-control plan-img-input" name="image" accept="image/*" style="flex:1;">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
            ...
            class HyipPlan{
                ...
                setupEditModal(){
                    ...
                    if(resource){
                        ...
                        var imgSrc = resource.image ? '{{ asset("assets/images/plan") }}/' + resource.image : '';
                        if(imgSrc){
                            modal.find('.plan-current-img').attr('src', imgSrc).show();
                            modal.find('.plan-img-placeholder').hide();
                        }else{
                            modal.find('.plan-current-img').hide();
                            modal.find('.plan-img-placeholder').show();
                        }
                    }
                }
            }
