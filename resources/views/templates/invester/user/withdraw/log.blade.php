...
@forelse($withdraws as $withdraw)
        <div class="recharge list">
                ...
                <div>
                    <p>wthhdraw</p>
                    <p class="num"><span>{{ $general->cur_text }}</span> {{ showAmount($withdraw->amount ) }} </p>
                    <p>Gatway Name: {{ __(@$withdraw->method->name) }}</p>
                </div>
                <div class="time">
                    <p>{{showDateTime($withdraw->created_at,'M d Y g:i:a')}}</p><br><br>
                    <p>Status:  @php echo $withdraw->statusBadge @endphp</p>
                </div>
