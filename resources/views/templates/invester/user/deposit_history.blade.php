...
<script>
 ...
 @forelse($deposits as $deposit)
        <div class="recharge list">
                ...
                <div>
                    <p>Recharge</p>
                    <p class="num"><span>{{ $general->cur_text }}</span> {{ showAmount($deposit->amount) }} </p>
                    <p>Gatway Name: {{ __($deposit->gateway?->name) }}</p>
                </div>
                <div class="time">
                    <p>{{ showDateTime($deposit->created_at, 'M d Y g:i:a') }}</p><br><br>
                    <p>Status:  @php echo $deposit->statusBadge @endphp</p>
                </div>
